...
import edu.fiuba.algo3.model.pregunta.OrderedChoice;
...
public class OrderedChoiceTest {
    ...
    public void test01SeIntentaCrearOrderedChoiceSinSuficientesOpciones() {
        ...
        assertThrows(CantidadOpcionesInvalida.class, () -> {
            ...
            Pregunta orderedChoice = new OrderedChoice("Elegir las opcionesOrdenadas que dicen Si", opcionesOrdenadas,opcionesOrdenadas, "", "");
    ...
    public void test02SeIntentaCrearOrderedChoiceConDemasiadasOpciones(){
        ...
        assertThrows(CantidadOpcionesInvalida.class, () -> {
            ...
            Pregunta orderedChoice = new OrderedChoice("Elegir las opciones que dicen Si", opcionesOrdenadas,opcionesOrdenadas, "", "");
            orderedChoice.evaluarRespuestas(opcionesOrdenadas);
        });
    }
    ...
    public void test03PuedoSeleccionarUnaPreguntaOrderedChoiceCorrectamente(){
        ...
        Pregunta orderedChoice = new OrderedChoice("Pregunta de multiple choice",opcionesOrdenadas, opcionesOrdenadas, "", "");
